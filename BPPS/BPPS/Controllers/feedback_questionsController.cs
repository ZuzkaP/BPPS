...
namespace BPPS.Controllers
{
    public class feedback_questionsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.feedback_id = new SelectList(db.feedbacks.Where(f => f.received == null), "feedback_id", "feedback_id");                
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "question_id,feedback_id")] feedback_questions feedback_questions)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
            //    TempData["message"] = "Question: " + "<i>" + feedback_questions.question_id + "</i> was added to feedback";
